    ...
    return (
      <div className="min-h-screen flex bg-[#0A0A0F]">
        ...
        <div className="flex-1 flex">
          {/* Left Panel - 55% */}
          <div className="w-[55%] overflow-auto border-r border-slate-800">
            <div className="px-8 py-8">
              {/* Header with Wallet & Disconnect */}
              <div className="flex items-center justify-between mb-8">
                <div>
                  <h1 className="text-2xl font-bold text-white">Dashboard</h1>
                  <p className="text-slate-400 text-sm">{kaminoPositions.length} positions monitored across Kamino</p>
                </div>
                <div className="text-right">
                  <p className="text-white font-mono text-sm font-semibold mb-2">{truncatedAddress}</p>
                  <button
              ...
              {/* Last Updated Line */}
              <p className="text-slate-500 text-xs mb-6">Last checked 14s ago · Updates every 30s</p>

              {/* WHAT ARGUS RECOMMENDS Card */}
              <div className={`rounded-xl p-6 mb-8 border backdrop-blur-md bg-linear-to-br ${
                overallRiskStatus === "safe"
                ...
                <p className={`text-xs font-semibold uppercase tracking-wide mb-2 ${
                  overallRiskStatus === "safe"
                    ...
                    : overallRiskStatus === "caution"
                      ? "text-amber-400"
                      : "text-red-400"
                }`}>What Argus Recommends</p>
                <h3 className="text-lg font-bold text-white mb-3">{recommendation.heading}</h3>
                <p className="text-slate-400 text-sm mb-6 leading-relaxed">{recommendation.body}</p>
              ...
              <p className="text-xs font-semibold uppercase tracking-wide text-slate-400 mb-4">Your Positions</p>
          ...
          <div className="w-[45%] bg-linear-to-b from-slate-900/50 to-slate-950/50 border-l border-slate-800 flex flex-col sticky top-0 h-screen">
            <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-blue-500/20 flex items-center justify-center">
                  <span className="text-blue-400">💬</span>
                </div>
                <h2 className="text-lg font-semibold text-white">Argus AI</h2>
              </div>
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-8 overflow-auto">
              <div className="text-center">
                ...
                <p className="text-slate-400 text-sm mb-2">AI Assistant Setup</p>
                <p className="text-slate-500 text-xs max-w-xs">
                  Your AI chat panel is being prepared. Ask Argus AI about your positions, strategies, and risk analysis.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="min-h-screen flex items-center justify-center px-8 py-20 border-t border-slate-800">
          <div className="max-w-4xl w-full">
            <div className="text-center mb-16">
              ...
              <p className="text-slate-400 text-lg">Argus protects your DeFi positions with real-time monitoring and automated actions</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="backdrop-blur-md bg-linear-to-br from-slate-900/40 to-slate-950/40 border border-blue-500/20 rounded-2xl p-8 hover:border-blue-500/40 transition-all">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  Link your wallet read-only. Argus indexes your Kamino vaults, leverage positions, and collateral ratios instantly.
                </p>
              </div>
              ...
              <div className="backdrop-blur-md bg-linear-to-br from-slate-900/40 to-slate-950/40 border border-blue-500/20 rounded-2xl p-8 hover:border-blue-500/40 transition-all">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Monitor 24/7</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Real-time health factor tracking across all your positions with configurable alert thresholds.
                </p>
              </div>
              ...
              <div className="backdrop-blur-md bg-linear-to-br from-slate-900/40 to-slate-950/40 border border-blue-500/20 rounded-2xl p-8 hover:border-blue-500/40 transition-all">
                ...
                <h3 className="text-xl font-bold text-white mb-3">Auto-Protect</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  When risk spikes, Argus executes pre-approved deleverage or top-up actions automatically.
                </p>
              </div>
            </div>
            ...
            <div className="mt-16 backdrop-blur-md bg-linear-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-2xl p-8">
              <div className="flex items-start gap-4">
                <span className="text-2xl">🔐</span>
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">Your security, our priority</h4>
                  <p className="text-slate-400 text-sm">
                    Argus never holds your funds. All actions require your explicit approval. We use session keys with limited permissions and time-based expiration.
                  </p>
                </div>
              </div>
            </div>
